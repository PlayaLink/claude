...
SHARED_GUIDELINES_DIR="$SCRIPT_DIR"
...
build_codex_block() {
...

  {
    ...
    echo ""
    echo "_Generated by \`$SCRIPT_DIR/sync.sh\` on $(date +%Y-%m-%d)._"
...
echo "🔄 Syncing AI guidelines across workspace projects..."
echo ""
